...
# About Me
I am a Ph.D. student major in Computer Science in [BDSC lab](https://bdsc-uic.github.io/) at [University of Illinois Chicago (UIC)](https://www.uic.edu/), where I am fortunate to be supervised by [Prof. Philip S. Yu](https://cs.uic.edu/profiles/philip-yu/).
...
from [Dalian University of Technology (DUT)](https://en.dlut.edu.cn/), and obtained my bachelor’s degree from [China University of Petroleum (UPC)](https://english.upc.edu.cn/). I am grateful to [Prof. Wenhao Luo](https://engineering.tamu.edu/cse/profiles/luo-wenhao.html) for his mentorship and guidance during my earlier doctoral research in robotics and safe autonomous systems. 
...
# 🔥 News
- **[July 2026]** Our paper about adaptive uncertainty quantification is accepted by [CDC 2026](https://cdc2026.ieeecss.org/).
...
- *2017, 2019* [RoboMaster](https://www.robomaster.com/en-US) International First Price.
...
## External Reviewer
- IEEE Conference on Decision and Control (CDC' 26)
...
- The Conference on Robot Learning (CoRL' 25, CoRL' 26)
